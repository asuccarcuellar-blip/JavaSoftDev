...
public class ChiliToGo {
        public static void main(String[] args) 
    {
        ...
        System.out.println("Please enter the number of children's meals >> ");
        noChildMeals = input.nextInt();
        System.out.println("Please enter the number of adult's meals >> ");
        ...
        System.out.printf("The total ammount of money collect for children's meals is $%.2f\n",  totalChild);
        System.out.printf( "The total ammount of money collect for adult's meals is $%.2f\n",  totalAdult);
